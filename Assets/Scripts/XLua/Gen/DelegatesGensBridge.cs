...
namespace XLua
{
    public partial class DelegateBridge_Wrap : DelegateBridge
    {
		...
		public void __Gen_Delegate_Imp6(UnityEngine.Sprite p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp7(UnityEngine.Object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(UnityEngine.Texture p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<UnityEngine.GameObject>(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Sprite>))
			{
			    return new System.Action<UnityEngine.Sprite>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Object>))
			{
			    return new System.Action<UnityEngine.Object>(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Texture>))
			{
			    return new System.Action<UnityEngine.Texture>(__Gen_Delegate_Imp8);
			}
