...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineProfilingProfilerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 20, 8, 5);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetTotalFragmentationInfo", _m_GetTotalFragmentationInfo_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetAllocatedMemoryForGraphicsDriver", _m_GetAllocatedMemoryForGraphicsDriver_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "EmitFrameMetaData", _m_EmitFrameMetaData_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "EmitSessionMetaData", _m_EmitSessionMetaData_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "enableAllocationCallstacks", _g_get_enableAllocationCallstacks);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "enableAllocationCallstacks", _s_set_enableAllocationCallstacks);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetTotalFragmentationInfo_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    Unity.Collections.NativeArray<int> _stats;translator.Get(L, 1, out _stats);
                    
                        var gen_ret = UnityEngine.Profiling.Profiler.GetTotalFragmentationInfo( _stats );
                        LuaAPI.lua_pushint64(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_EmitSessionMetaData_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Profiling.Profiler.EmitSessionMetaData( _id, _tag, _data );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_enableAllocationCallstacks(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushboolean(L, UnityEngine.Profiling.Profiler.enableAllocationCallstacks);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_enableAllocationCallstacks(RealStatePtr L)
        {
		    try {
                
			    UnityEngine.Profiling.Profiler.enableAllocationCallstacks = LuaAPI.lua_toboolean(L, 1);
